                    ...
                    <motion.div animate={floatingAnim} className="relative w-[280px] h-[560px] rounded-[2.5rem] shadow-2xl bg-[#05150E] border border-white/10 overflow-hidden">
                      ...
                      <div className="absolute inset-0 p-5 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-around text-white text-xs">
                          <div className="flex flex-col items-center gap-1"><Zap className="w-4 h-4 text-emerald-400" /><span>Actions</span></div>
                          <div className="flex flex-col items-center gap-1"><Signal className="w-4 h-4 text-blue-400" /><span>Network</span></div>
                          <div className="flex flex-col items-center gap-1"><Bot className="w-4 h-4 text-purple-400" /><span>AI Chat</span></div>
                        </div>
                      </div>
                      <motion.div
                        animate={{ y: [0, -5, 0] }}
                        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                        className="absolute top-6 right-6 p-3 rounded-2xl bg-white shadow-lg flex flex-col gap-1 z-30"
                      >
                        <div className="flex items-center gap-2">
                          <div className="w-5 h-5 rounded-md bg-blue-100 flex items-center justify-center text-blue-600"><Smartphone className="w-3 h-3" /></div>
                          <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Mobile Optimized</span>
                        </div>
                        <span className="text-sm font-black text-[#05150E]">Zero Data Mode</span>
                      </motion.div>
                    </motion.div>
                  </motion.div>
                )}
