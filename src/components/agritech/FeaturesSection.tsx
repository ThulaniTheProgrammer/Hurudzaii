...
const features = [
  ...
  },
  {
    ...
    description: 'The future of agricultural liquidity. A revolutionary fintech engine enabling produce-backed commerce, instant micro-financing, and direct market settlements optimized for the African farmer.',
    stat: 'ZundePay',
    color: '#2ECC71',
  },
];
