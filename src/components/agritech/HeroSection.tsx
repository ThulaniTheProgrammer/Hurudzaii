...
const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate }) => {
  ...
  const stats = [
    ...
    { icon: Globe, value: '1500+', label: 'Verified hectares', color: '#2ECC71' },
  ];
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-32 pt-8 pb-20 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}>
            ...
            Hurudza AI transforms indigenous african agricultural knowledge into sovereign AI-powered climate positive digital assets.</p>
